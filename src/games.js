...
export const GAMES = [
  ...
  { world: 'korean', id: 'k1', name: '받아쓰기 스튜디오', icon: '🎙️', grad: 'linear-gradient(160deg,#ff6f9c,#d13a6a)', kind: 'dom', scene: 'k1', ready: false },
  { world: 'korean', id: 'k2', name: '띄어쓰기 슬래시', icon: '⚔️', grad: 'linear-gradient(160deg,#ffb84d,#e0812f)', kind: 'phaser', scene: 'k2', ready: false },
  { world: 'korean', id: 'k3', name: '겹받침 징검다리', icon: '🐸', grad: 'linear-gradient(160deg,#4dd0a6,#2a9d76)', kind: 'phaser', scene: 'k3', ready: false },
];
